                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-xl-4 col-lg-12 col-md-9">
                                    <div class="col-lg-12">
                                        <div class="p-5">
                                            <form method="POST" action="update_data_kriteria.php?id=<?php echo $id_data ?>">
                                                <table border="0" cellpadding="10" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td>Simbol : </td>
                                                        <td><input type="text" name="inputsimbol" class="form-control form-control-user" id="exampleYear" value="<?php echo $simbol ?>" style="-moz-appearance: textfield;" required></td>
                                                    </tr>
                                                    <tr>
